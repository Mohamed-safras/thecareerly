...
const ControlButton: React.FC<ControlButtonProps> = ({
  ...
  <Tooltip>
      ...
      <div className="relative flex flex-col items-center">
        <Button
          ...
          className={cn(
            ...
            danger && "bg-[#c4314b] hover:bg-[#a52a3f] text-secondary",
            active &&
              !danger &&
              "bg-[#6264a7] hover:bg-[#5254a3] text-secondary",
            !active &&
              !danger &&
              "bg-[#3d3d3d] hover:bg-[#4a4a4a] text-secondary",
            selected &&
    ...
    <TooltipContent side="top" className="border-[#3d3d3d] text-white">
      {label}
    </TooltipContent>
  </Tooltip>
);
