...
const SchedulePanel: React.FC<SchedulePanelProps> = ({ setCurrentStep }) => {
  ...
  const { jobForm } = useAppSelector(({ jobs }) => jobs); // has logoFileId, etc.
    ...
    <div className="space-y-4 border p-4 rounded">
      ...
      <div className="flex flex-wrap items-center justify-between gap-2">
        ...
        <div className="flex justify-end gap-2">
          <Button
            disabled={
              Object.keys(formErrors.byForm.create_basic_info).length > 0 &&
              Object.keys(formErrors.byForm.create_job_decription).length > 0
            }
            variant="outline"
