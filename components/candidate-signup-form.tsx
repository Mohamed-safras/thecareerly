...
import { CONNECT_CANDIDATE_lOGIN } from "@/constents/router-links";
import {
  Form,
  FormControl,
  FormField,
...
import useCandidateSignUp from "@/hooks/use-candidate-signup";

export function CandidateSignupForm({
  className,
  ...props
}: React.ComponentProps<"div">) {
  const { form, onSubmit } = useCandidateSignUp();
